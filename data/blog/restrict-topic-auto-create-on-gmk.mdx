...
<Image
  src="/static/images/restrict-topic-auto-create-on-gmk/Terminal.gif"
...
Once you've applied it, you'll see an unauthorised error when trying to publish to a non-existent topic.
