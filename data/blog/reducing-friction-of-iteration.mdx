...
There are many approaches I could have taken to achieve a similar outcome, but the key idea I want to get across is abstracting out the model and system prompts so that they can be easily iterated on.
