...
When designing a distibuted system, we can also think of allocating resources based on their function, and/or expected usage, i.e. reserving more resources for components with greater demands or vice versa.
