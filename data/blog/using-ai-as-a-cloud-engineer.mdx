...
It has been over 3 years since the ChatGPT moment happened, and it feels as though we are all still trying to understand how AI fits into our work and lives.
...
The premise of vibe coding is that you have AI generate code whilst you as the engineer are behind the wheel coordinating the whole thing via natural language.
...
If I know the change I am making has relatively low/minor impact, then I might lean on AI more heavily, e.g. a bash script that makes some part of my job easier.

There is no hard and fast rule for this; and a big part of what we do is knowing which tools to use and not to use.
